  ...
  de: {
    ...
    faq: {
      ...
      items: [
        ...
        { question: "In welchen Sprachen ist die App verfügbar?", answer: "Offerto PROFI ist vollständig auf Deutsch, Französisch, Italienisch und Englisch verfügbar." },
  ...
  fr: {
    ...
    faq: {
      ...
      items: [
        ...
        { question: "Dans quelles langues l'app est-elle disponible?", answer: "Offerto PROFI est entièrement disponible en allemand, français, italien et anglais." },
  ...
  it: {
    ...
    faq: {
      ...
      items: [
        ...
        { question: "In quali lingue è disponibile l'app?", answer: "Offerto PROFI è completamente disponibile in tedesco, francese, italiano e inglese." },
  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        { question: "In which languages is the app available?", answer: "Offerto PROFI is fully available in German, French, Italian and English." },
