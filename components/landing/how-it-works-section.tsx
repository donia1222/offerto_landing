...
const steps = [
  {
    number: "1",
    title: "Angebote durchstöbern",
    description: "Scrolle durch hunderte aktuelle Angebote von Aligro, TopCC und Transgourmet. Filtere nach Kategorie, Händler oder Rabattstufe — auf Deutsch, Französisch oder Italienisch.",
  },
  {
    number: "2",
    title: "Zur Einkaufsliste hinzufügen",
    description: "Füge interessante Angebote mit einem einzigen Tippen zur persönlichen Einkaufsliste hinzu. Sieh sofort, wie viel du in dieser Woche sparst.",
  },
  {
    number: "3",
    title: "Im Lager einkaufen",
    description: "Öffne deine Einkaufsliste beim Einkaufen — auch komplett ohne Internetverbindung. Hake erledigte Artikel ab und behalte jederzeit den Überblick.",
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="font-[family-name:var(--font-display)] text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-4 text-balance">
            In 3{" "}
            <span className="text-primary">einfachen Schritten.</span>
          </h2>
          <p className="text-lg text-muted-foreground leading-relaxed">
            Von der Suche bis zum Einkauf — alles in einer App.
          </p>
        </div>
